...
namespace RatchetEdit
{
    public class SpawnPoint
    {
        ...
        public SpawnPoint(byte[] spawnPointBlock, int index)
        {
            ...
            v12 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x04);
            v13 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x08);
            v14 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x0C);

            v21 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x10);
            v22 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x14);
            v23 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x18);
            v24 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x1C);

            v31 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x20);
            v32 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x24);
            v33 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x28);
            v34 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x2C);

            v41 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x30);
            v42 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x34);
            v43 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x38);
            v44 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x3C);

            mat1 = new Matrix4(v11, v12, v13, v14, v21, v22, v23, v24, v31, v32, v33, v34, v41, v42, v43, v44);

            v11 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x40);
            v12 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x44);
            v13 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x48);
            v14 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x4C);

            v21 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x50);
            v22 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x54);
            v23 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x58);
            v24 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x5C);

            v31 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x60);
            v32 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x64);
            v33 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x68);
            v34 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x6C);

            v41 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x70);
            v42 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x74);
            v43 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x78);
            v44 = ReadFloat(spawnPointBlock, (index * 0x80) + 0x7C);
